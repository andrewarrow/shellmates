      ...
      <div className="container mx-auto py-8 px-4">
        <div className="max-w-3xl mx-auto mb-12">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-primary-300">Technical Co-Founder Icebreaker</h1>
            <p className="text-gray-300 mt-2">Answer 9 questions to find your perfect technical match</p>
          </div>
          <IceBreaker />
        </div>
      </div>
